   ...
   <div class="col-sm-12" style=" margin-top: 50px; ">
    ...
    <thead style="border: 4px solid black; font-size: px; ">
      <tr style="background-color: black; color: white;">
        ...
        <th  style="border: 2px solid white;text-align: center;">Edit</th>
      </tr>
...
if (mysqli_num_rows($run)<1)
  {
	...
	{	
        ...
        <td  style="border: 2px solid black; "><a href="updateform.php?sid=<?php echo $data['id']; ?>"   style="text-decoration: none;" ><button class="btn-info" style="margin-top: 17px; height: 40px;  border-radius: 12%;"> Edit</button> </a></td>
      </tr>
